...
class Vote extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            candidates: [],
            loading: true,
            electionId: this.props.match.params.id // Get election ID from URL params
        }
    }
        ...
        try {
            ...
            if(networkData) {
                ...
                const electionCandidates = allCandidates.filter(
                    candidate => candidate.election_id.toString() === this.state.electionId
                )
                ...
                console.log('Candidates loaded:', electionCandidates)
            } else {
