                ...
                <form onSubmit={this.handleSubmit}>
                    <div className="input-field">
                        <input 
                            ...
                            required
                        />
                        <label htmlFor="candidate_name" className="active">Candidate Name</label>
                    </div>
                    <div className="input-field">
                        <input 
                            type="text" 
                            id="candidate_details" 
                            value={this.state.candidate_details}
                            className="validate"
                            onChange={this.handleInputChange} 
                            required
                        />
                        <label htmlFor="candidate_details" className="active">Candidate Details</label>
                    </div>
                    <button 
